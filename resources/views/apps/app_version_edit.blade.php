...
@section('content')
    ...
    @if($app)
        <form class="pb-2" action="{{route('admin.apps.update')}}" method="post">
            @method('PUT')
            @csrf
            ...
            <div class="row">
                <div class="col-12 col-sm-6">
                    @include('apps.create_form_input_group',['name'=>'version_name','label'=>'Version','require'=>true, 'defaultValue'=>$app->version_name??null])
                </div>
                <div class="col-12 col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    @include('apps.create_form_input_group',['name'=>'download_url','label'=>'Download URL', 'defaultValue'=>$app->download_url??null])
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-sm-6">
            ...
            <button class="btn btn-success d-block mx-auto mt-2" type="submit">Update</button>
        </form>
    @else
        <div class="mb-2">
            <b>Not found!</b>
